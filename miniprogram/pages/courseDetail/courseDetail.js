...
var demo = new QQMapWX({
  key: '4ZPBZ-QZOKP-2IQDH-LFWOI-62L23-RIFTJ' // 必填
});
...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.cloud.callFunction({
      ...
      data: {
        orderId: this.data.courseInfo._id,
    ...
    var opt = {
      ...
      url: 'https://apis.map.qq.com/ws/direction/v1/driving/?from=' + startPos + '&to=' + endPos + '&key=4ZPBZ-QZOKP-2IQDH-LFWOI-62L23-RIFTJ',
      method: 'GET',
      dataType: 'json',
      //请求成功回调
